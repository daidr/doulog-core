...
type UpdateUserInfoReq struct {
	...
	NewMotto    string `json:"motto" form:"motto" binding:"omitempty,max=300,sensitive,xss"`
...
type UpdateUserInfoUri struct {
	...
	TargetField string `uri:"field" binding:"required,oneof=name email homepage motto"`
}
